...
Replace this section with the supported versions for `ctxshrink`.
...
Do not imply paid support, guaranteed response times, guaranteed fixes, or service-level agreements unless `ctxshrink` explicitly provides them.

## Scope

In scope:

- Vulnerabilities in ctxshrink.
